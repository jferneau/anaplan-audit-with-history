"""Model History Upload — generate CSVs from SQLite and push to Anaplan.

After model history data has been persisted to SQLite, this module reads
...
def upload_model_history(
    ...
    """Read model history from SQLite and upload all three CSVs to Anaplan.
